...
// BufferGeometryUtils - 从全局THREE获取
const toTrianglesDrawMode = window.THREE.BufferGeometryUtils?.toTrianglesDrawMode || function(geometry, drawMode) {
    // 简单回退：直接返回原geometry
    return geometry;
};;
...
// 挂载到全局THREE
if (window.THREE) window.THREE.GLTFLoader = GLTFLoader;;
